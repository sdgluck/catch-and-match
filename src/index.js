...
(function () {
    ...
    function isIllegalArguments ({ fn, cb, matcher }) {
        ...
        if (
            ...
            return Promise.reject(new Error(unrecognisedMatcherMessage));
        }
    ...
    function doesMatch ({ matcher, err }) {
        ...
        throw new Error(unrecognisedMatcherMessage);
    }
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        throw new Error(`Environment is not supported. Please raise an issue at ${issuesUrl}`);
    }
})();
